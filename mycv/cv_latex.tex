...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{Department of Materials Science and Metallurgy, Changwon National University}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://youngung.github.io/}{https://youngung.github.io}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/youngung}{https://github.com/youngung}}%
    \end{header}
...
%        \end{onecolentry}
    ...
    \begin{samepage}
        ...
        \begin{twocolentry}{2018 - 2024}
            \textbf{Engineering Research Center, National Research Foundation of Korea}
        \end{twocolentry}
        \vspace{0.10 cm}
    ...
    \section{Skills}
        \begin{onecolentry}
            ...
            \item Experimental Mechanics: uniaxial tension, shear, hydraulic bulge test, biaxial tests, digital image correlation (DIC)
            \item Diffraction experiments: X-ray diffraction, Electron back-scattered diffraction (EBSD), Residual stress analysis
        \end{onecolentry}
