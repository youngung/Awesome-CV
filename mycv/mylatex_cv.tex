...
%    \end{onecolentry}
    ...
    \section{Education}
        ...
        \begin{twocolentry}{Mar 2008 – Feb 2010}
            \textbf{POSTECH}, MS, GIFT
        \end{twocolentry}
        \vspace{0.10 cm}
        \begin{twocolentry}{Mar 2008 – Feb 2010}
            \textbf{POSTECH}, PhD, GIFT
        \end{twocolentry}
        \vspace{0.10 cm}
    \section{Experience}
        \begin{twocolentry}{Mar 2017 – Present}
            \textbf{Assistant, Associate professor}, Changwon National University, Republic of Korea
        \end{twocolentry}
        \vspace{0.10 cm}
        ...
        \begin{twocolentry}{Dec 2016 – Feb 2017}
            \textbf{Postdoc}, POSTECH, Republic of Korea
        \end{twocolentry}
        \vspace{0.10 cm}
